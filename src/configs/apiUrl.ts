...
export const GEOSERVER_SERVICE = 'http://103.116.52.103:8080/geoserver/smartgis_test/wms?bbox={bbox-epsg-3857}&format=image/png&service=WMS&version=1.1.1&request=GetMap&srs=EPSG:3857&transparent=true&width=256&height=256&layers=';
